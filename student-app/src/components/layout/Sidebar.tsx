...
import {
  Bus, Map, QrCode, Scan, Settings, ChevronLeft, ChevronRight, UserCircle
} from 'lucide-react';

const menuItems = [
  { label: 'My Bus', icon: Bus, path: '/student/home', roles: ['STUDENT'] },
  { label: 'Track Bus', icon: Map, path: '/student/map', roles: ['STUDENT'] },
  { label: 'Digital Pass', icon: QrCode, path: '/student/pass', roles: ['STUDENT'] },
  { label: 'Scan to Board', icon: Scan, path: '/student/scan', roles: ['STUDENT'] },
];
          ...
          <AnimatePresence>
            {!sidebarCollapsed && (
              ...
              >
                ...
                <p className="text-[10px] text-slate-500 leading-none">Student Portal</p>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
