...
import {
  Bus, Map, QrCode, Scan, ChevronLeft, ChevronRight, UserCircle, LogOut
} from 'lucide-react';

const menuItems = [
  { label: 'My Bus', icon: Bus, path: '/student/home' },
  { label: 'Track Bus', icon: Map, path: '/student/map' },
  { label: 'Digital Pass', icon: QrCode, path: '/student/pass' },
  { label: 'Scan to Board', icon: Scan, path: '/student/scan' },
