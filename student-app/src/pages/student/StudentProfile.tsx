...
import {
  UserCircle, Mail, Phone, GraduationCap, BookOpen, Calendar,
  MapPin, LogOut, Save, Loader2, Camera
} from 'lucide-react';
  ...
  return (
    <div className="max-w-lg mx-auto space-y-5 pb-8">
      ...
      >
        ...
        <p className="text-sm text-indigo-400 font-medium mt-1">{user?.role?.replace('_', ' ')}</p>
      </motion.div>
      ...
      >
        <h3 className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-3">Academic Information</h3>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm font-medium text-slate-200">{user?.studentProfile?.studentId || '—'}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-xs text-slate-500">Department & Section</p>
            <p className="text-sm font-medium text-slate-200">
              {user?.studentProfile?.department || '—'} — Section {user?.studentProfile?.section || '—'}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm font-medium text-slate-200">Year {user?.studentProfile?.year || '—'}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm font-medium text-slate-200">{user?.studentProfile?.boardingPoint || '—'}</p>
          </div>
        </div>
      </motion.div>
