...
import {
  ...
  Settings, ChevronLeft, ChevronRight, Brain, UserCircle, LogOut,
} from 'lucide-react';

const menuItems = [
  { label: 'Dashboard', icon: LayoutDashboard, path: '/dashboard', roles: ['SUPER_ADMIN', 'ADMIN', 'SCHEDULER', 'DEPOT_MANAGER'] },
  { label: 'Buses', icon: Bus, path: '/buses', roles: ['SUPER_ADMIN', 'ADMIN', 'DEPOT_MANAGER'] },
  { label: 'Drivers', icon: Users, path: '/drivers', roles: ['SUPER_ADMIN', 'ADMIN', 'DEPOT_MANAGER'] },
  ...
  { label: 'Depots', icon: Building2, path: '/depots', roles: ['SUPER_ADMIN', 'ADMIN', 'DEPOT_MANAGER'] },
  ...
  { label: 'Live Tracking', icon: Map, path: '/tracking', roles: ['SUPER_ADMIN', 'ADMIN', 'SCHEDULER', 'DEPOT_MANAGER', 'DRIVER'] },
  { label: 'Maintenance', icon: Wrench, path: '/maintenance', roles: ['SUPER_ADMIN', 'ADMIN', 'DEPOT_MANAGER'] },
  { label: 'Fuel', icon: Fuel, path: '/fuel', roles: ['SUPER_ADMIN', 'ADMIN', 'DEPOT_MANAGER'] },
  { label: 'Attendance', icon: ClipboardCheck, path: '/attendance', roles: ['SUPER_ADMIN', 'ADMIN', 'DEPOT_MANAGER', 'DRIVER'] },
  { label: 'Analytics', icon: BarChart3, path: '/analytics', roles: ['SUPER_ADMIN', 'ADMIN', 'SCHEDULER'] },
  { label: 'Reports', icon: FileText, path: '/reports', roles: ['SUPER_ADMIN', 'ADMIN', 'SCHEDULER', 'DEPOT_MANAGER'] },
  { label: 'Notifications', icon: Bell, path: '/notifications', roles: ['SUPER_ADMIN', 'ADMIN', 'SCHEDULER', 'DEPOT_MANAGER', 'DRIVER'] },
];
          ...
          <AnimatePresence>
            {!sidebarCollapsed && (
              ...
              >
                ...
                <p className="text-[10px] text-slate-500 leading-none">Bus Management</p>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
